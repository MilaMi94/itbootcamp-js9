...
console.log("Zadatak 9------------na stranici------------------------------------------");
...
console.log(`Proizvod svih brojeva u intervalu od 20 do 100 koji su deljivi sa 11 je: ${p}`);
...
console.log(`U intervalu od ${n} do ${m} ima ${brojP} pozitivnih brojeva i ${brojN} negativnih brojeva.`);
...
console.log(`U intervalu od ${n} do ${m} ima ${brojTri} brojeva deljivih samo sa 3 i ${brojPet} brojeva deljivih samo sa 5.`);
